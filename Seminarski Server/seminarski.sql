...
(1,'Java developer','Senior','2021-12-21','Trazimo vrhunskog programera sa 10 godina iskustva. Nudimo dobre uslove i stoni tenis na poslu (hehe ionako necete imati vremena da ga igrate naivcine).','Msg'),
(2,'Azure Cpp developer','Medior','2022-02-01','Mi smo Microsoft. Nemamo sta vise da kazemo, sve je jasno.','Microsoft'),
(3,'C#','Junior','2022-04-14','Developeri su nam malo sranje ali imamo besplatnu hranu, super pocetne plate koje rastu godisnje za cak 5 evra ako se bas potrudite i manekenke koje vam seku jabuke, sta covek vise moze pozeleti u zivotu.','Nordeus');
